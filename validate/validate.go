...
func (this numeric) Validate(obj interface{}) error {
...
func (this match) Validate(obj interface{}) error {
...
func (this *compare) Validate(obj interface{}) error {
...
func (this *required) Validate(obj interface{}) error {
	if objIsNotNil(obj) {
		return nil
	}
